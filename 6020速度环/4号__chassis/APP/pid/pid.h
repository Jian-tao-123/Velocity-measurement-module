...
//角度环宏定义
#define aPID_OUT_MAX          150	                	//即最大速度	//150
#define aPID_OUT_MAX_CHASSIS          50		//即最大速度//50
#define aPID_OUT_MAX_FOLLOW      10     //  20		//即最大速度
#define aP_OUT_MAX_FOLLOW          10//	20
...
#define pid_init() \
				do{ \
					/*底盘位置环*/                        \
					chassis_center.pid.position_loop.pid_Parameter.Akp = 0.05; \
					...
					chassis_center.pid.speed_loop.pid_Parameter.Vkd = 0.1; \
					                   \
					/*轮子速度环*/       \
					chassis_motor1.pid.speed_loop.pid_Parameter.Vkp = 5.0;   \
					chassis_motor1.pid.speed_loop.pid_Parameter.Vki = 0.1;   \
					chassis_motor2.pid.speed_loop.pid_Parameter.Vkp = 6.5;   \
					chassis_motor2.pid.speed_loop.pid_Parameter.Vki = 0.05;   \
					chassis_motor3.pid.speed_loop.pid_Parameter.Vkp = 5.1;   \
					chassis_motor3.pid.speed_loop.pid_Parameter.Vki = 0.12;   \
					chassis_motor4.pid.speed_loop.pid_Parameter.Vkp = 5.1;   \
					chassis_motor4.pid.speed_loop.pid_Parameter.Vki = 0.12;   \
\
					/*功率环*/   \
					p_pid.kp=4.6; \
					p_pid.ki=1.8; \
